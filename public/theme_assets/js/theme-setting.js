...
$("#darkButton").on("click", function () {
    ...
    document
        ...
        .setAttribute("href", "{{asset('theme_assets')}}') }}/css/dark.css");
});
...
$("#lightButton").on("click", function () {
    ...
    document
        .getElementById("color-link")
        .setAttribute("href", "{{asset('theme_assets')}}') }}/css/style.css");
    console;
});
...
$(".rtl").on("click", function () {
    if ($("body").hasClass("ltr")) {
        ...
        $("#rtl-link").attr(
            "href",
            "{{asset('theme_assets')}}') }}/css/vendors/bootstrap.rtl.css"
        );
    } else {
        $("html").attr("dir", "");
        ...
        $("#rtl-link").attr(
            "href",
            "{{asset('theme_assets')}}') }}/css/vendors/bootstrap.css"
        );
    }
});
