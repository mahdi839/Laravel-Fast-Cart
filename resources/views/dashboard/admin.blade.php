                            ...
                            <div class="media static-top-widget">
                                <div class="media-body p-0">
                                    ...
                                    <h4 class="mb-0 counter">
                                        ...
                                        <a href="{{ route('add.new.admin') }}" class="badge badge-light-secondary grow">
                                            ADD NEW</a>
                ...
                <div class="col-sm-6 col-xxl-3 col-lg-6">
                    <div class="main-tiles border-5 card-hover border-0 card o-hidden">
                        <div class="custome-3-bg b-r-4 card-body">
                            <div class="media static-top-widget">
                                <div class="media-body p-0">
                                    <span class="m-0">Total Applied Vendor</span>
                                    <h4 class="mb-0 counter">
                        ...
                        <div>
                            <div class="table-responsive">
                                <table class="best-selling-table table border-0">
                                    <tbody>
                                        @foreach ( $applied_vendors as $applied_vendor )
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('vendor.approve', $applied_vendor->id ) }}" class="btn btn-sm btn-info">Approve</a>
                                            </td>
